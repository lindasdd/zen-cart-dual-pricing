...
<!--- Dual Pricing start --->
	    		<div class="col-xs-2 col-sm-2 col-md-2 col-lg-1 smallText">
			    <?php echo TABLE_HEADING_OPT_PRICE_W; ?><br /><input type="text" name="value_price_w" value="<?php echo $attributes_values->fields['options_values_price_w']; ?>" >
			</div>
<!--- Dual Pricing end --->
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-1">
