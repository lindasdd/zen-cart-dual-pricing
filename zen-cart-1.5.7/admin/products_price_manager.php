...
<!--- Dual Pricing start --->
            <div class="form-group">
		<?php echo zen_draw_label(TEXT_PRICE_W, 'products_price_w', 'class="col-sm-3 control-label"'); ?>
	      <div class="col-sm-9 col-md-6">
	          <?php echo zen_draw_input_field('products_price_w', (isset($pInfo->products_price_w) ? $pInfo->products_price_w : ''), 'class="form-control"' . $readonly); ?>
	      </div>
	    </div>
<!---Dual Pricing end ---> 
          </div>
...
<!--- Dual Pricing start --->
            	<?php echo '<span class="errorText">' . TEXT_FEATURED_DISABLED . '</span>'; ?>
<!--- Dual Pricing end --->
              </div>
            <?php } ?>
          <?php } else { ?>
